...
import type { UnderlineStyle } from './types/index.ts';

type TeamTabType = 'overview' | 'standings' | 'matches' | 'stats';

interface TeamTabNavigationProps {
    activeTab: TeamTabType;
    onTabClick: (tabKey: TeamTabType, index: number) => void;
}

const tabs: { key: TeamTabType; label: string }[] = [
...
export default function TeamTabNavigation({ activeTab, onTabClick }: TeamTabNavigationProps) {
