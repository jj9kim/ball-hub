...
const ReserveIndicator: React.FC<ReserveIndicatorProps> = ({
    ...
    return (
        <div
            className="flex items-center justify-between p-2 cursor-pointer hover:bg-[#2a2a2a] opacity-60"
        ...
        >
            ...
            <div className={`w-2 h-2 rounded-full ${isTeam1 ? 'bg-[#1e88e5]' : 'bg-[#e53935]'}`} />
        </div>
    );
};
