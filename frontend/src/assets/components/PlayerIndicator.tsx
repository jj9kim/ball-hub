...
export default function PlayerIndicator({ player, onPlayerClick }: PlayerIndicatorProps) {
    return (
        <div className='border-red-600 border-2 bg-red-100 bg-opacity-20'>
            <div>
                <div
                ...
                >
                    ...
                    <div className="relative hover:opacity-50 w-50 h-50 flex flex-col items-center">
                        <div className='absolute -top-3 right-15 bg-[#32c771] rounded-full w-8 h-6 flex items-center justify-center text-black font-bold text-sm z-10'>{player.stats?.player_rating}</div>
                        {player.photoUrl ? (
            ...
            <div className='mt-400 h-100 border-white border-2'>
            </div>
        </div>
    );
}