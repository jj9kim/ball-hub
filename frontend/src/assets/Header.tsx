...
function Header() {
    ...
    return (
        <div className="h-1/10 mt-0 bg-[#1a1a1a] flex justify-between w-full z-500 sticky top-0">
            <div className="flex pl-15 bg-[#1a1a1a] pt-1 cursor-pointer" onClick={handleHomeClick}>
            ...
            <div className="flex flex-row pr-5">
                <div className="pt-6 max-lg:hidden lg:block">
                    <button
                        className="text-white font-bold text-2xl hover:text-[#9f9f9f]"
