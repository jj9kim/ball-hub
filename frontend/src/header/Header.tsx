...
function Header() {
  return (
      <div className="h-1/10 w-full mt-0 bg-[#1a1a1a] flex">
          <div className="flex pl-15 bg-[#1a1a1a]">
              <img src={logo} className="h-20 w-20 right-30 hover:rotate-4" alt="logo" />
              <h2 className="pt-3.5 font-bold text-white text-5xl hover:text-[#9f9f9f]">BallHub</h2>
        </div>
        <div className="pl-20 pt-4">
            <form className="max-w-md mx-auto">
                  ...
                  <div className="relative">
                      ...
                      <input type="search" id="default-search" autoComplete="off" className="focus:outline-none block w-75 p-3 ps-10 text-sm text-white rounded-2xl bg-[#2c2c2c]" placeholder="Search"/>
                  </div>
              </form>
        </div>
        <div className="pl-70 pt-5">
            <button className="text-white font-bold text-3xl hover:text-[#9f9f9f]">Table</button>
        </div>
    </div>
  )
}
